...
This project is a sentiment analysis API built using FastAPI, Redis, and VADER sentiment analysis. It includes a Jupyter Notebook for implementation, API endpoints, and a UI.
